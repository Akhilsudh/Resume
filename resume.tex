...
\begin{document}
    ...
    \section{Professional Summary}    
        I am a \textbf{senior software developer} currently working at \textbf{OpenText}, Bengaluru. With \textbf{over 6 years} of working experience as an individual contributor, I offer technical expertise in designing, developing and maintaining scalable \textbf{Springboot Java applications, microservices} and interactive \textbf{React web user interfaces} for the IT Operations Management (ITOM) suite. I have a proven track record of delivering software in a \textbf{SAFe® Agile} release cycle with high velocity. I also have experience in handling live customer defect debugging \& resolution.
    ...
    \section{Work History \& Projects}
        ...
        \begin{twocolentry}{
            ...
            {\textbf{{\color{MidnightBlue}Senior Software Developer (SDE III)} | OpenText -- Bengaluru, India}}\end{twocolentry}
