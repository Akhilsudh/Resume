...
\begin{document}
    ...
    \section{Professional Summary}    
        I am a senior software developer currently working at OpenText, Bengaluru. With over 6 years of working experience as an individual contributor, I offer technical expertise in designing, developing and maintaining scalable Java applications, microservices and interactive web user interfaces in React for the IT Operations Management (ITOM) suite. I have a proven track record of delivering software in a SAFe® Agile release cycle with high velocity and additionally have experience in handling live customer defect debugging and resolution.
    ...
    \section{Technologies}    
        ...
        \end{onecolentry}
        \begin{onecolentry}
            \textbf{Frameworks:} SpringBoot, Hibernate, Junit(TDD), JBehave(BDD), React, Selenium
        \end{onecolentry}
        \begin{onecolentry}
            \textbf{Miscellaneous:} Git, Maven, Postgres, Vertica, Redis, SAFe® Agile, RabbitMQ, Microservices, Linux, Windows, WSL, Jenkins, Docker, Kubernetes, AWS
        \end{onecolentry}
